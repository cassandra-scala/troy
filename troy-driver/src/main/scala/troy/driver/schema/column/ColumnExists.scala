 ...
 */
trait ColumnExists[Version, T <: TableName[_, _], Name]

object ColumnExists {
  implicit def instance[V, K <: MaybeKeyspaceName, T <: Identifier, Name <: Identifier](implicit ct: ColumnType[V, TableName[K, T], Name]) =
    new ColumnExists[V, TableName[K, T], Name] {}
}
